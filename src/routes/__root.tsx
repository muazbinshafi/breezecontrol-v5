...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Your Live Dev deploys and hosts live previews of your web projects, enabling real-time editing and collaboration." },
      { property: "og:description", content: "Your Live Dev deploys and hosts live previews of your web projects, enabling real-time editing and collaboration." },
      { name: "twitter:description", content: "Your Live Dev deploys and hosts live previews of your web projects, enabling real-time editing and collaboration." },
    ],
    links: [
